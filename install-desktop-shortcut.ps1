...
$shortcutPath = Join-Path $desktopPath 'Olos-AI Mini Budget Planner - Hackathon.lnk'
...
$shortcut.Description = 'Open the isolated Olos-AI Mini Budget Planner hackathon app without a console window'
